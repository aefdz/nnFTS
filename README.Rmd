...
## Curve Extension
```{r, message = FALSE}
tcut <- 25 # number of points observed of the partially observed function
kcurves <- 10 # number of curves of the envelope involved in the band

pl <- plotBand(sinedata, tcut, resultsBand$Jordered, kcurves, focal)
```
...
manipulate(
  {
  plotBand(sinedata, tcut, results$Jordered, kcurves, focal)
  },
